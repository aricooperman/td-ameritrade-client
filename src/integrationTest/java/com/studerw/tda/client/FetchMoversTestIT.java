...
public class FetchMoversTestIT extends BaseTestIT {
  ...
  public void testDJI() {
    ...
    final List<Mover> movers = BaseTestIT.httpTdaClient.fetchMovers(moversReq);
    Assertions.assertThat(movers).isNotNull();
    Assertions.assertThat(movers.size()).isBetween(0, 10);
